...
var weekdayZH=new make_array("日", "一", "二", "三","四", "五", "六");
var ShengXiaoZH=new make_array("鼠", "牛", "虎", "兔", "龍", "蛇",
    "馬", "羊", "猴", "雞", "狗", "豬");
var GanZH=new make_array("甲", "乙", "丙", "丁", "戊",
    "己", "庚", "辛", "壬", "癸");
var ZhiZH=new make_array("子", "丑", "寅", "卯", "辰", "巳",
    "午", "未", "申", "酉", "戌", "亥");
...
var monthZH=new make_array("正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "臘");
var dateZH=new make_array("初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十",
...
{
 var d = new Date();
 Lunar(0, d.getFullYear(), d.getMonth()+1, d.getDate());
 var month = d.getMonth()+1;
 var date = d.getDate();
 var s = d.getFullYear() + "/" + (month<10 ? "0"+month : month) + "/";
 s += (date<10 ? "0"+date : date) + "(星期" + weekdayZH[solar.w] + ") ";
 s += "農曆(" + GanZH[gan.y] + ZhiZH[zhi.y] + ")" + (lunar.l?"閏":"");
 s += monthZH[lunar.m-1] + "月" + dateZH[lunar.d-1];
...
function report(type,ans) {
  var answer,answer2;
  if(type==0) { //陽->陰
    //answer="您查詢的結果為(農曆):<font color='red'>"+lunar.y+"("+GanZH[gan.y]+ZhiZH[zhi.y]+")年"+(lunar.l?"閏":"")+lunar.m+"月"+lunar.d+"日</font>";
      answer = lunar.y + "," + lunar.m + "," + lunar.d + "," + mday[lunar.m];
  }
  else {
    answer="您查詢的結果為(國曆):<font color='red'>"+solar.y+"年"+solar.m+"月"+solar.d+"日</font>"; 
  }
  return answer;
}
/*----------------------------------------------------------*/
...
function check_ymd(y,m,d,myerr) {
  if(y<1901 || y>2049) {
	 ...
	 document.getElementById("show_info").innerHTML = "<font color='red'>年份只能介於 1901 至 2049 之間</font>";
     return false;
  }
  switch(m) {
    case 2:
          if((y%4==0) && d>29) {
			  ...
			  document.getElementById("show_info").innerHTML = "<font color='red'>"+m+"月只有29天</font>";
              return false;
          }
          else if((y%4!=0) && d>28) {
              //myerr.value=""+m+"月只有 28天";
			  document.getElementById("show_info").innerHTML = "<font color='red'>"+m+"月只有28天</font>";
              return false;
          }
	  break;
    case 4: 
    ...
    case 11: 
          if(d>30) {
			...
			document.getElementById("show_info").innerHTML = "<font color='red'>"+m+"月只有30天</font>";
            return false;
          }
  }
  return true;
...
//	document.getElementById("show_info").innerHTML = "<font color='red'>年份只能填數字</font>";
//    return;
//  }
